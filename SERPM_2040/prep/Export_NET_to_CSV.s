...
FILEI NODEI[1] = "DAILY_LOADED_3.net"
...
PRINT CSV=T, LIST=A(10.0L),B(10.0L),1(10.4L),CAPACITY(10.0L),NUM_LANES(5.0L),FTC2(5.0L),FFSPD(5.1L),ALPHA(5.2L),BETA(5.2L),PRINTO=1
